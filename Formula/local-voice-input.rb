class LocalVoiceInput < Formula
  ...
  url "https://github.com/aimer1124/local-voice-input/archive/refs/tags/v1.8.4.tar.gz"
  sha256 "25d69388919950c514b0d9be11d9c1a92946ba9f4471ad16b836bceed289a46a"
  license "MIT"
  ...
  resource "hud" do
    url "https://github.com/aimer1124/local-voice-input/releases/download/v1.8.4/hud"
